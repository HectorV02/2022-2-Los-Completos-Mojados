...
public class PrimaryController {
    ...
    public void Empezar(int x ,int y){
        ...
        mayusculas(p, puntos, smallP, smallPuntos);
    }

    public static void mayusculas(Pane p, ArrayList<ArrayList> puntos, Pane smallP, ArrayList<ArrayList> smallPuntos) {
        ...
        Caracter c = new Caracter(ix, iy, fx, fy, ch1x, ch1y, ch2x, ch2y, p, 0);
        ...
        ch2x = new ArrayList(Arrays.asList(smallPuntos.get(15).get(0), smallPuntos.get(33).get(0), smallPuntos.get(21).get(0)));
        ch2y = new ArrayList(Arrays.asList(smallPuntos.get(15).get(1), smallPuntos.get(33).get(1), smallPuntos.get(21).get(1)));
        c = new Caracter(ix, iy, fx, fy, ch1x, ch1y, ch2x, ch2y, smallP, ix.size());
        letras.add(c);
        ...
        c = new Caracter(ix, iy, fx, fy, ch1x, ch1y, ch2x, ch2y, p, 3);
        letras.add(c);
